      ...
      <div className="flex min-h-screen flex-col items-center justify-between p-28 bg-bgGradient">
        <div className="w-full bg-gray-100 p-5 border rounded-md mt-10">
          <Accordion type="single" collapsible className="w-full">
            <h4 className="scroll-m-20 py-1.5 text-lg text-blue-950 font-semibold tracking-tight">
              Your Entries
            </h4>
            <AccordionItem value="item-1">
              <AccordionTrigger className="text-blue-950">
                01.13.2024
              </AccordionTrigger>
              <AccordionContent>
                <p className="leading-7 [&:not(:first-child)]:mt-6 text-blue-950">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Commodi perspiciatis explicabo beatae, unde nam, eaque
                  suscipit tempora officia temporibus esse, laborum alias
                  dolorem! Quos, tenetur? At delectus quia odio laudantium.
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                  Dolorum, culpa voluptatibus facilis doloremque ipsam
                  praesentium ab veniam doloribus ducimus consectetur harum
                  dolorem nisi obcaecati ipsum quibusdam, deleniti ipsa, quae
                  beatae.
                </p>
